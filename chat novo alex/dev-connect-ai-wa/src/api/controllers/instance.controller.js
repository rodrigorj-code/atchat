...
exports.init = async (req, res) => {
    ...
    let importOldMessages = req.body.importOldMessages || null;
    let importOldMessagesGroups = req.body.importOldMessagesGroups || false;
    let dateRecentLimit = req.body.dateRecentLimit || null;
    ...
    if (valida) {
        ...
        sessions.push({ key: key, ignoreGroups: ignoreGroups, webhook: webhook, base64: base64, webhookUrl: webhookUrl, browser: browser, webhookEvents: webhookEvents, messagesRead: messagesRead, importOldMessages: importOldMessages, importOldMessagesGroups: importOldMessagesGroups, dateRecentLimit: dateRecentLimit, });
