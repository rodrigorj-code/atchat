...
router.route('/sendMy1').post(keyVerify, loginVerify, controller.sendMy1);
router.route('/sendMy2').post(keyVerify, loginVerify, controller.sendMy2);
router.route('/text').post(keyVerify, loginVerify, controller.Text)
router.route('/edit').post(keyVerify, loginVerify, controller.editMessage);
...
router.route('/delete').post(keyVerify, loginVerify, controller.deleteMessage);
router.route('/read-message').post(keyVerify, loginVerify, controller.readMessage);

router.route('/all-messages').get(keyVerify, loginVerify, controller.getAllMessages);
router.route('/contact-messages').get(keyVerify, loginVerify, controller.getMessagesByContact);
router.route('/total-messages').get(keyVerify, loginVerify, controller.getTotalMessages);
router.route('/total-messages/contact').get(keyVerify, loginVerify, controller.getTotalMessagesByContact);
